...
SET ventas_totales = EXCLUDED.ventas_totales,
    margen_utilidad = EXCLUDED.margen_utilidad,
    stock_critico = EXCLUDED.stock_critico,
    reclamos_activos = EXCLUDED.reclamos_activos,
...
SET sales_value = EXCLUDED.sales_value;
